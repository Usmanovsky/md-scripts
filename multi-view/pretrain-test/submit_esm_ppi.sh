...
#SBATCH --job-name humanppi-4gpu			#Nameof the job
#SBATCH --output slurm-humanppi4g-%j.out                #Output file name
#SBATCH -e slurm-humanppi4g-%j.err                      #error file name
...
#SBATCH --time=35:00:00					#Time required for the Jupyter job
...
python3 -m torch.distributed.launch --nproc_per_node=4 script-peer/run_single_ESM_ppi.py -c ./config/single_task/ESM/human_ESM_fix.yaml --seed 0
