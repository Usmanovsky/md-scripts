...
#SBATCH --time=06:00:00					#Time required for the Jupyter job
...
#python3 script-peer/run_single_ESM_stability.py -c ./config/single_task/ESM/stability_ESM_fix.yaml --seed 0
python3 -m torch.distributed.launch --nproc_per_node=4 script-peer/run_single_ESM_stability.py -c ./config/single_task/ESM/stability_ESM_fix.yaml --seed 0
#load model
