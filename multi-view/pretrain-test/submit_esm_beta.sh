...
#python3 script-peer/run_single_ESM_beta.py -c ./config/single_task/ESM/beta_ESM_fix.yaml --seed 0
python3 -m torch.distributed.launch --nproc_per_node=4 script-peer/run_single_ESM_beta.py -c ./config/single_task/ESM/beta_ESM_fix.yaml --seed 0
