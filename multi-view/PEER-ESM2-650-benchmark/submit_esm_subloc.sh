...
#SBATCH --job-name seed2sublocEsm2-650M			#Nameof the job
#SBATCH --output slurm-subloc-esm2-650-seed2-%j.out                #Output file name
#SBATCH -e slurm-subloc-esm2-650-seed2-%j.err                      #error file name
...
#SBATCH --time=48:00:00					#Time required for the J_v2.pyter job
...
python3 -m torch.distributed.launch --nproc_per_node=1 script/run_single.py -c ./config/single_task/ESM/subloc_ESM.yaml --seed 2
