...
#SBATCH --job-name seed0ssEsm2-650M			#Nameof the job
#SBATCH --output slurm-ss-esm2-650-seed0-%j.out                #Output file name
#SBATCH -e slurm-ss-esm2-650-seed0-%j.err                      #error file name
...
python3 -m torch.distributed.launch --nproc_per_node=1 script/run_single.py -c ./config/single_task/ESM/ss_ESM.yaml --seed 0
