#python script/run_single_ESM_beta.py -c ./config/single_task/ESM/beta_ESM.yaml --seed 0
#python script/run_single_ESM_beta.py -c ./config/single_task/ESM/solubility_ESM.yaml --seed 0
...
def build_solver(cfg, logger):
    ...
    model = R.search("ESM_ourembedding")(path=cfg.task.model.path,model=cfg.task.model.model,readout="mean")
