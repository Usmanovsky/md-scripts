#python script/run_single_ESM_PPI.py -c ./config/single_task/ESM/human_ESM_fix.yaml --seed 0
import os
import sys
import math
import pprint
...
def build_solver(cfg, logger):
    ...
    task=tasks.InteractionPrediction(model, model2=None, task=_dataset.tasks, criterion=cfg.task.criterion, metric=cfg.task.metric, num_mlp_layer=cfg.task.num_mlp_layer, num_class=cfg.task.num_class)
