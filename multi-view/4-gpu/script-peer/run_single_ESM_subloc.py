#python script/run_single_ESM_subloc.py -c ./config/single_task/ESM/subloc_ESM.yaml --seed 0
...
def build_solver(cfg, logger):
    ...
    task = tasks.PropertyPrediction(model, task=_dataset.tasks,criterion=cfg.task.criterion, metric=cfg.task.metric, num_mlp_layer=cfg.task.num_mlp_layer)
