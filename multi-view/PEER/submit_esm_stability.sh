...
#SBATCH --job-name multiview-stability			#Nameof the job
#SBATCH --output slurm-stability-%j.out                #Output file name
#SBATCH -e slurm-stability-%j.err                      #error file name
...
python3 script-peer/run_single_ESM_stability.py -c ./PEER_Benchmark/config/single_task/ESM/stability_ESM_fix.yaml --seed 0
load model
