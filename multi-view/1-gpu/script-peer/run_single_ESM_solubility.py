#python script/run_single_ESM_solubility.py -c ./config/single_task/ESM/solubility_ESM.yaml --seed 0
...
def build_solver(cfg, logger):
    ...
    task = tasks.PropertyPrediction(model, task=_dataset.tasks,criterion=cfg.task.criterion, metric=cfg.task.metric, num_mlp_layer=cfg.task.num_mlp_layer,num_class=cfg.task.num_class)
