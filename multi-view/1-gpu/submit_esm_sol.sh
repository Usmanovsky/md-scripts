...
#SBATCH --job-name sol-1GPU			#Nameof the job
#SBATCH --output slurm-solubility1gpu-%j.out                #Output file name
#SBATCH -e slurm-solubility1gpu-%j.err                      #error file name
...
#python3 script-peer/run_single_ESM_solubility.py -c ./config/single_task/ESM/solubility_ESM.yaml --seed 0
python3 -m torch.distributed.launch --nproc_per_node=1 script-peer/run_single_ESM_solubility.py -c ./config/single_task/ESM/solubility_ESM.yaml --seed 0
#load model
