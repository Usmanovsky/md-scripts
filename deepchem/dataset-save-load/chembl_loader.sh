...
#SBATCH  --job-name=chembl-joblib-loader
#SBATCH --output=chembl25_loadjoblib__16Apr2022.out
...
singularity run --app deepchem250gpu --nv -B $HOME/.local-dc:$HOME/.local /share/singularity/images/ccs/conda/lcc-conda-1-rocky8.sinf python *_loader.py
