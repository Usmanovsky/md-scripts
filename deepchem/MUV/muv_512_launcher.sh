...
#SBATCH  --job-name=muv-512train
#SBATCH --output=muv512_17Mar2022.out
...
singularity run --app deepchem250gpu --nv -B $HOME/.local-dc:$HOME/.local /share/singularity/images/ccs/conda/lcc-conda-1-rocky8.sinf python muv_512_trainer.py
