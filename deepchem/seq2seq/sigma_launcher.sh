...
#SBATCH  --job-name=seq2seq-sigma
#SBATCH --output=seq_sigma_18Mar2022.out
...
singularity run --app deepchem250gpu --nv -B $HOME/.local-dc:$HOME/.local /share/singularity/images/ccs/conda/lcc-conda-1-rocky8.sinf python seq2seq_sigma.py
