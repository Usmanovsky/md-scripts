...
#SBATCH  --job-name=chembl25test-2gpu-50epochs
#SBATCH --output=chembl25test_20cores_2gpu_22Apr2022.out
...
singularity run --app deepchem250gpu --nv -B $HOME/.local-dc:$HOME/.local /share/singularity/images/ccs/conda/lcc-conda-1-rocky8.sinf python *_tester.py
