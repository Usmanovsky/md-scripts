...
#SBATCH  --job-name=chembl25-train-256-cuda
#SBATCH --output=chembl256_cuda_18Apr2022.out
...
singularity run --app deepchem250gpu --nv -B $HOME/.local-dc:$HOME/.local /share/singularity/images/ccs/conda/lcc-conda-1-rocky8.sinf python *_test.py
