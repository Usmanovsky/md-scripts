...
gmx_gpu editconf -f $6 -o $new_name.gro -scale $4 $5 1 > $new_name$r.log
...
gmx_gpu editconf -f $new_name.gro -o $new_name$c.gro -bt cubic
echo 'Gro file boxed'
...
gmx_gpu mdrun -s $new_name$e.tpr -o $new_name$e.trr -c $name$r.gro -e $new_name$e.edr -g $new_name$e.log $options_md
echo 'NPT mdrun done'
