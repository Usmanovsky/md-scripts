...
compound2 = des[1][0:3]
molar_ratio = des[1][3:]
distance_zshift = (max_z1 - min_z2) + 0.1  # trying to avoid too-close contact
print(compound1, compound2)
gro3_name = des[0] + des[1] + ".gro"

try:
    os.system(f"sbatch ./mol_shifter-lcc.sh {compound1} {compound2} {molar_ratio} {distance_zshift};")
except:
    print("sbatch did not work. Now trying LabGPU")
