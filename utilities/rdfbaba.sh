...
rdfbaba(){ 
	...
	{ echo 'a O04 & 2'; echo 'a O07 & 3'; echo q; } | gmx_gpu make_ndx -f $tl11$b.gro -o $1-$r.ndx
        { echo 4; echo 4; echo 5; exec 0<&-; } | gmx_gpu rdf -n $1-$r.ndx -f traj_comp.xtc -s $tl11$f$num.tpr -o $tl11$r-112.xvg
        { echo 5; echo 5; exec 0<&-; } | gmx_gpu rdf -n $1-$r.ndx -f traj_comp.xtc -s $tl11$f$num.tpr -o $tl11$r-22.xvg
        ;;
	tl21)
	...
	{ echo 'a O04 & 2'; echo 'a O00 & 3'; echo q; } | gmx_gpu make_ndx -f $tm11$b.gro -o $1-$r.ndx
        { echo 4; echo 4; echo 5; exec 0<&-; } | gmx_gpu rdf -n $1-$r.ndx -f traj_comp.xtc -s $tm11$f$num.tpr -o $tm11$r-112.xvg
        { echo 5; echo 5; exec 0<&-; } | gmx_gpu rdf -n $1-$r.ndx -f traj_comp.xtc -s $tm11$f$num.tpr -o $tm11$r-22.xvg
        ;;
	tm21)
