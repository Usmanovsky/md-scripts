...
tags="O0-N8H-A-B O7-O0H-B-A N2-O0H-B-A O0H-O0H-A-A O7-N8H-B-B"
{ echo 'a O00 & 2'; echo 'a O07 & 3'; echo 'a N08 H0U & 3'; echo 'a O00 H0E & 2'; echo 'a N02 & 3'; echo 'a N08 & 3'; echo q; } | gmx_gpu make_ndx -f $name$c.gro -o $name$h.ndx
