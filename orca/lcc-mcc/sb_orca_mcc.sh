...
#SBATCH --job-name=am1-6jxt32-QMMM-SVP    # Job name
...
#SBATCH -e slurm-6jxt32-D4-b3lyp-SVP-AM1-%j.err             # Error file for this job.
#SBATCH -o slurm-6jxt32-D4-b3lyp-SVP-AM1-%j.out             # Output file for this job.
