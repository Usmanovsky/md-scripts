...
# make batch2
python3 find-diff-pandas.py v4_updated_accessions.txt batch1.csv not-in-batch-1.csv
python3 select-samples.py not-in-batch-1.csv batch2.csv

#make batch3
python3 find-diff-pandas.py not-in-batch-1.csv batch2.csv not-in-batch-2.csv
python3 select-samples.py not-in-batch-2.csv batch3.csv

#make batch4
python3 find-diff-pandas.py not-in-batch-2.csv batch3.csv not-in-batch-3.csv
python3 select-samples.py not-in-batch-3.csv batch4.csv

#make batch5
python3 find-diff-pandas.py not-in-batch-3.csv batch4.csv not-in-batch-4.csv
python3 select-samples.py not-in-batch-4.csv batch5.csv
