...
{ echo 'a O04 & 2'; echo 'a C* & 2'; echo 'a O00 & 3'; echo 'a C* & 3'; echo q; } | gmx_gpu make_ndx -f $name$c.gro -o $name$x.ndx
...
{ echo 7; echo 7; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $o4-$1-density.xvg -relative > $o4-$1-density.log
{ echo 8; echo 8; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $c-$1-density.xvg -relative > $c-$1-density.log
{ echo 9; echo 9; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $o0-$2-density.xvg -relative > $o0-$2-density.log
...
python3 /data/ulab222/script/xvg2dat.py $o4-$1-density.xvg
