...
{ echo 'a O02 & 2'; echo 'a O00 & 2'; echo 'a C* & 2'; echo 'a O07 & 3'; echo 'a C* & 3'; echo q; } | gmx_gpu make_ndx -f $name$c.gro -o $name$x.ndx
...
{ echo 7; echo 7; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $o2-$1-density.xvg -relative > $o2-$1-density.log
{ echo 8; echo 8; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $o0-$1-density.xvg -relative > $o0-$1-density.log
{ echo 9; echo 9; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $c-$1-density.xvg -relative > $c-$1-density.log
{ echo 10; echo 10; } | gmx_gpu density -f $name$f.trr  -s $name$f.tpr  -n $name$x.ndx  -o $o7-$2-density.xvg -relative > $o7-$2-density.log
...
python3 /path/to/script/xvg2dat.py $o7-$2-density.xvg
