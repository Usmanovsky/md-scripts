...
{ echo 'a O04 & 2'; echo 'a O00 & 3'; echo 'a O04 H0F & 2'; echo 'a O00 H0E & 3'; echo q; } | gmx_gpu make_ndx -f $name$c.gro -o $name$h.ndx
tags="O4-O0H-A-B O0-O4H-B-A O4H-O4H-A-A O0H-O0H-B-B"
for x in $tags
do
        a=$x
